...
public class ExceptionCode {
    public static final String BAD_REQUEST_CODE = "com.example.vu.ParkingManagement.exception.base.BadRequestException";
    public static final String CONFLICT_CODE = "com.example.vu.ParkingManagement.exception.base.ConflictException";
    public static final String NOT_FOUND_CODE = "com.example.vu.ParkingManagement.exception.base.NotFoundException";
    public static final String DUPLICATE_CODE = "com.example.vu.ParkingManagement.exception.DuplicateNameException";
    public static final String USER_NOT_FOUND_CODE = "com.example.vu.ParkingManagement.exception.base.NotFoundException.UserNotFoundException";
